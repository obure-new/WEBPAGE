...
import { MapPin, Phone, Twitter, Facebook, Linkedin, Instagram, Youtube } from 'lucide-react';
    ...
    <footer className="bg-white py-16 border-t border-gray-200">
      <div className="container mx-auto px-4 grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm">© Copyright 2025 CIC Group.</p>
        </div>

        {/* Contact */}
        <div>
          <h4 className="font-semibold text-gray-800 mb-6">CIC Head Office</h4>
          <div className="space-y-4 text-gray-600 text-sm">
            <div className="flex items-start">
              <MapPin className="w-5 h-5 mr-3 text-red-600" />
              <span>CIC Plaza, Mara Road, Upperhill Nairobi, Kenya</span>
            </div>
            <div className="flex items-center">
              <Phone className="w-5 h-5 mr-3 text-red-600" />
              <span>(+254) 703 099 120 (020) 282 3000</span>
            </div>
          </div>
        </div>
