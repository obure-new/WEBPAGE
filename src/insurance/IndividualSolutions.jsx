      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-8 h-full flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <button className="bg-yellow-400 text-black px-8 py-4 rounded-full font-semibold hover:bg-yellow-300 transition-colors duration-300 transform hover:scale-105">
              Learn More
            </button>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-2/3">
              <div className="relative">
                {scrollIndex > 0 && (
                  <button
                    className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white shadow-lg rounded-full p-3"
                ...
                {scrollIndex < valuablesCards.length - 3 && (
                  <button
                    className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white shadow-lg rounded-full p-3"
